...
namespace StudyPilotApp.Migrations
{
    ...
    [Migration("20260921190639_SyncFacultyAssessmentModel")]
    partial class SyncFacultyAssessmentModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudyPilotApp.Models.FacultyCourseAssignment", b =>
                {
                    ...
                    b.HasIndex("FacultyProfileId", "CatalogCourseId", "AcademicPeriodId", "Section")
                        .IsUnique();
            ...
            modelBuilder.Entity("StudyPilotApp.Models.FacultyProfile", b =>
                {
                    ...
                    b.Property<string>("TeachingInterests")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
